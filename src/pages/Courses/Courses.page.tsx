...
import { Box, Button, Card, CardActions, CardContent, CardMedia, Container, FormControl, InputLabel, MenuItem, Select, ThemeProvider, Typography, createTheme } from '@mui/material';
          ...
          <Container component="main" maxWidth="xs" sx={{ marginTop: 20 }}>
            ...
            >
              <Card sx={{ width: '700px', }}>
                ...
                <CardActions>
                  <Button sx={{ background: "black", color: 'white', }}><Link to={`/courses/${id}`} style={linkStyle}>Перейти к курсу</Link></Button>
                </CardActions>
              </Card>
            </Box>
          </Container>
